...
urlpatterns = [
    ...
    path("appointments/<str:workspace_name>/<int:appointment_id>/book-surgery/", views.book_surgery_from_appointment, name="book_surgery_from_appointment"),
    path("appointments/<str:workspace_name>/<int:appointment_id>/follow-up/calendar/", views.follow_up_calendar_data, name="follow_up_calendar_data"),
    path("appointments/<str:workspace_name>/<int:appointment_id>/follow-up/slots/", views.follow_up_slots_data, name="follow_up_slots_data"),
    path("appointments/<str:workspace_name>/<int:appointment_id>/follow-up/book/", views.book_follow_up_from_appointment, name="book_follow_up_from_appointment"),
